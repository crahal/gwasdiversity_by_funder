...
def create_summarystats(data_path):
    ...
    try:
        ...
        sumstats['by_funder'] = {}
        make_sumstats_headline(sumstats, 'All', Cat_Anc_NoNR)
...
def make_doughnut_year(year):
    ...
    for ancestry in merged['Broader'].unique().tolist():
        ...
        doughnut_df.at[counter, 'Funder'] = 'All'
